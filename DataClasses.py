...
# RBennett, 2020- March-22, Modified per Lab09-A/B instructions
#------------------------------------------#
...
class Track():
    ...
    properties:
        track_position: (int) with Track position on CD / Album
    ...
    """
    # -- Constructor -- #
    def __init__(self, track_position: int, track_title: str, track_length: str) -> None:
        """Set ID, Title and Artist of a new CD Object"""
        #    -- Attributes  -- #
        try:
            self.__track_position = int(track_position)
    ...
    def __str__(self):
        ...
        return '{:>2}\t{} ({})'.format(self.track_position, self.track_title, self.track_length)
